/* hash_set.go - a set implementation */
/*
...
/*
DESCRIPTION
    an implementation of set, use []byte pool in order to reduce time of gc
    for more details: http://wiki.babel.baidu.com/twiki/bin/view/Main/GO_BFE_DOCUMENT
Usage:
    import "www.baidu.com/golang-lib/hash_set"

    // elementNum: num of the element
    // elementSize: max size of each element
    set := hash_set.NewHashSet(elementNum, elementSize, false, nil)
